"""
Bug 16: TorchJIT numerical inconsistency — torch 2.11.0+cu128
Max diff: 31.14
Ops: ['Constant', 'Slice', 'ReduceMean', 'Input', 'Max', 'Sigmoid', 'Atan', 'Linear', 'TorchReduceSum', 'Less', 'GELU', 'Tan']
...
BUG_DIR = Path("/home/binduan/myspace/compilerTesting/nnsmith_results/torchjit_2.11/bug-Symptom.INCONSISTENCY-Stage.VERIFICATION-16")
...
trace_inputs = [
    torch.tensor([[5.086744785308838]], dtype=torch.float32),
]
# eval_inputs: the oracle inputs that expose the divergence
eval_inputs = [
    torch.tensor([[3.771042585372925]], dtype=torch.float32),
]
...
print(f"Bug 16: torch {torch.__version__}")
