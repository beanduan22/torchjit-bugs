"""
Bug 25: TorchJIT numerical inconsistency — torch 2.11.0+cu128
Max diff: 2.07
Ops: ['Constant', 'Slice', 'Sigmoid', 'Input', 'ReLU', 'Mul', 'CastI64', 'ExpandLast4', 'Linear', 'Linear', 'Tan', 'PTMatMul']
...
BUG_DIR = Path("/home/binduan/myspace/compilerTesting/nnsmith_results/torchjit_2.11/bug-Symptom.INCONSISTENCY-Stage.VERIFICATION-25")
...
trace_inputs = [
    torch.tensor(4.439439296722412, dtype=torch.float32),
]
# eval_inputs: the oracle inputs that expose the divergence
eval_inputs = [
    torch.tensor(6.350278854370117, dtype=torch.float32),
]
...
print(f"Bug 25: torch {torch.__version__}")
