"""
Bug 12: TorchJIT numerical inconsistency — torch 2.11.0+cu128
Max diff: 11.61
Ops: ['Constant', 'Clip', 'Input', 'Linear', 'Slice', 'Max', 'Linear', 'Slice', 'Tan', 'Min', 'Linear', 'Less']
...
BUG_DIR = Path("/home/binduan/myspace/compilerTesting/nnsmith_results/torchjit_2.11/bug-Symptom.INCONSISTENCY-Stage.VERIFICATION-12")
...
trace_inputs = [
    torch.tensor([6.473179817199707], dtype=torch.float32),
]
# eval_inputs: the oracle inputs that expose the divergence
eval_inputs = [
    torch.tensor([5.705303192138672], dtype=torch.float32),
]
...
print(f"Bug 12: torch {torch.__version__}")
